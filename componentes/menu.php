...
<body>
      ...
      <div class="row">
        ...
        <div class="list-group col-sm-6 col-sm-offset-1 col-md-6 ">
          <div class="panel panel-primary panel-transparent">
            <div class="panel-heading">
              <h3 class="panel-title ">!Bienvenido al sistema !</h3>
            </div>
            <div class="panel-body ">Elige una de las opciones para administrar los activos en desincorporacion</div>
          </div>
        </div>
      </div>
    </div>
